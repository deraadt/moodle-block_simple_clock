...
/**
 * Simple clock block language strings in French
 *
 * @package    contrib
 * @subpackage block_simple_clock
 * @copyright  2010 Luiggi Sansonetti
...
<p>Avec ces réglages, vous contrôlez l\'en-tête du bloc, incluant le titre.</p>
...
Quand le "Mode Edition" est éteint, l\'en-tête sera cachée.
...
<p>Avec ce réglage, vous pouvez contrôler si les icônes sont affichées à côté de chaque étiquette de l\'horloge.</p>
...
<p>Afficher le nom du jour ajoute des informations supplémentaires pour les étudiants qui peuvent être dans un fuseau horaire un jour plus tôt ou plus tard.</p>
';
$string['config_seconds'] = 'Afficher les secondes';
$string['config_seconds_help'] = '
<p>Ce réglage permet d\'afficher les secondes aux utilisateurs sur toutes les horloges visibles.</p>
...
<p>Ce paramètre permet de modifier le titre du bloc.</p>
<p>Si l\en-tête du bloc est masquée, le titre ne s\'affichera pas.</p>
';

// Other strings
$string['day_names'] = 'Dimanche,Lundi,Mardi,Mercredi,Jeudi,Vendredi,Samedi'; // Preserve this format
$string['javascript_disabled'] = 'Pour permettre aux horloges de se mettre à jour, activer JavaScript dans votre navigateur.';
$string['loading'] = 'Chargement...';
$string['pluginname'] = 'Simple Horloge';
$string['server'] = 'Paris3';
$string['you'] = 'Vous';
